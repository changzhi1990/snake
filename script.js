...
$(function(){
    ...
    var callFunction = "getRankingListTop3";
    var contract = {
...
function parseResult(resp){
  ...
  $('#no2score').html(no2score);
  $('#no2player').html(no2player);

  $('#no3score').html(no3score);
  $('#no3player').html(no3player);
